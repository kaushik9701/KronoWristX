  ...
  return (
    <>
      ...
      <div className="relative w-full min-h-screen overflow-hidden pointer-events-none">
        <div className="fixed top-24 inset-0 z-10 pointer-events-none">
          <ThreeDScene scrollPosition={scrollPosition} mousePosition={mousePosition} />
        </div>
        <div className="relative  flex flex-col">
            ...
            <h2 id="line2" className="text-5xl pt-6 sm:text-4xl md:text-4xl lg:mr-96  lg:text-2xl font-bold text-center text-white">"Where time bends, technology evolves, and style reigns"</h2>
