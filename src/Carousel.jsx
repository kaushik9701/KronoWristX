    ...
    <div className="w-[90%] max-w-[1200px] mx-auto text-center pt-20 sm:pt-16">
      ...
      <Slider {...settings}>
        <div className="relative flex flex-col items-center justify-center sm:flex-row sm:justify-between">
          ...
          <div className="absolute bottom-20 sm:bottom-5 left-1/2 transform -translate-x-1/2 w-4/5 bg-black bg-opacity-60 text-white py-4 px-5 rounded-lg text-center sm:block hidden">
          ...
          <p className="text-white sm:hidden text-sm text-center mt-4 px-4">Experience stunning clarity with the latest OLED screen technology, perfect for every lighting condition.</p>
        </div>
        <div className="relative flex flex-col items-center justify-center sm:flex-row sm:justify-between">
          ...
          <div className="absolute bottom-5 left-1/2 transform -translate-x-1/2 w-4/5 bg-black bg-opacity-60 text-white py-4 px-5 rounded-lg text-center sm:block hidden">
          ...
          <p className="text-white sm:hidden text-sm text-center mt-4 px-4">Take it anywhere, from the gym to the pool, with its waterproof design.</p>
        </div>
        <div className="relative flex flex-col items-center justify-center sm:flex-row sm:justify-between">
          ...
          <p className="text-white sm:hidden text-sm text-center mt-4 px-4">Track your workouts, steps, calories burned, and more with built-in sensors and fitness modes.</p>
        </div>
        <div className="relative flex flex-col items-center justify-center sm:flex-row sm:justify-between">
          ...
          <p className="text-white sm:hidden text-sm text-center mt-4 px-4">Stay powered for days with an efficient battery life that supports your busy schedule.</p>
        </div>
      </Slider>
    </div>
  );
